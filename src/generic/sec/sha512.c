...
static void sha512_append_byte(struct sha512 *sha, uint8_t byte) {
...
static void sha512_append(struct sha512 *sha, const void *src, size_t n_bytes) {
...
static void sha512_finalize(struct sha512 *sha) {
	int i;
...
static void sha512_finalize_bytes(struct sha512 *sha, void *dst_bytes32) {
